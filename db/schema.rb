...
ActiveRecord::Schema[7.1].define(version: 2024_03_11_182705) do
  create_table "categories", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "other_videos_subcategories", force: :cascade do |t|
    t.string "name"
  ...
  create_table "sports_videos_subcategories", force: :cascade do |t|
    t.string "name"
    t.integer "videography_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "travel_videos_subcategories", force: :cascade do |t|
    t.string "name"
    t.integer "videography_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
